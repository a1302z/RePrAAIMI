...
from .grad_acc import PrivateGradValuesAccumulation
...
class ComplexPrivateGradValues(PrivateGradValuesAccumulation):
    ...
    def _calc_std(self, l2_norm_clip, noise_multiplier, num_microbatches):
        return (
            super()._calc_std(l2_norm_clip, noise_multiplier, num_microbatches)
            * one_by_sqrt_two
        )
